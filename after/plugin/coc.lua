...
keyset("i", "<c-leader>", "coc#refresh()", {silent = true, expr = true})
...
keyset("n", "ccd", '<CMD>lua _G.show_docs()<CR>', {silent = true})
...
keyset("x", "<lennnr>f", "<Plug>(coc-format-selected)", {silent = true})
